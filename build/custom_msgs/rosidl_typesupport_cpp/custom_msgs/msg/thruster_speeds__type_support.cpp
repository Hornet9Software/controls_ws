...
static const _ThrusterSpeeds_type_support_symbol_names_t _ThrusterSpeeds_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msgs, msg, ThrusterSpeeds)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_msgs, msg, ThrusterSpeeds)),
  }
};
...
{
  return &::custom_msgs::msg::rosidl_typesupport_cpp::ThrusterSpeeds_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, custom_msgs, msg, ThrusterSpeeds)() {
  return get_message_type_support_handle<custom_msgs::msg::ThrusterSpeeds>();
}
