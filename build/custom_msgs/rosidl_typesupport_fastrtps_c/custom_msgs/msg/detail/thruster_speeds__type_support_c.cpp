...
#include "custom_msgs/msg/detail/thruster_speeds__rosidl_typesupport_fastrtps_c.h"
...
using _ThrusterSpeeds__ros_msg_type = custom_msgs__msg__ThrusterSpeeds;
  ...
  void * untyped_ros_message)
{
  ...
  _ThrusterSpeeds__ros_msg_type * ros_message = static_cast<_ThrusterSpeeds__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _ThrusterSpeeds__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_msgs__msg__ThrusterSpeeds(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_msgs__msg__ThrusterSpeeds;
    is_plain =
      (
...
static size_t _ThrusterSpeeds__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_msgs__msg__ThrusterSpeeds(
