...
#include "custom_msgs/msg/detail/cv_object__rosidl_typesupport_fastrtps_c.h"
...
using _CVObject__ros_msg_type = custom_msgs__msg__CVObject;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _CVObject__ros_msg_type * ros_message = static_cast<const _CVObject__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _CVObject__ros_msg_type * ros_message = static_cast<_CVObject__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_custom_msgs__msg__CVObject(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _CVObject__ros_msg_type * ros_message = static_cast<const _CVObject__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _CVObject__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_msgs__msg__CVObject(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_msgs
size_t max_serialized_size_custom_msgs__msg__CVObject(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_msgs__msg__CVObject;
    is_plain =
      (
...
static size_t _CVObject__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_msgs__msg__CVObject(
...
static message_type_support_callbacks_t __callbacks_CVObject = {
  "custom_msgs::msg",
  "CVObject",
...
static rosidl_message_type_support_t _CVObject__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_CVObject,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_msgs, msg, CVObject)() {
  return &_CVObject__type_support;
}
