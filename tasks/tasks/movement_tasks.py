...
from controls_ws.controls_core.controls_core.attitude_control import AttitudeControl
...
from controls_ws.controls_core.controls_core.utilities import pos_to_list, quat_to_list
